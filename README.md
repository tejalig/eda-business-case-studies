...
Before building dashboards, predictive models, or making business recommendations, analysts must first understand the data they are working with.

EDA helps us to answer questions such as:

- What patterns exist in the data?
- Are there unusual trends or anomalies?
- Which variables appear to influence business outcomes?
- Are there data quality issues that need to be addressed?
- What hypotheses can be generated for further investigation?
...
- Develop a structured approach to exploratory data analysis
